        ...
        <div class="w-full flex flex-col md:flex-row py-6">
          <div class="flex mb-6 text-black">
            <div class="flex items-center space-x-3 p-2">
              ...
              <a href="index.html" class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl">
                SID KENANGA
              </a>
            </div>
          </div>
          ...
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              ...
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Youtube</a>
              </li>
            </ul>
          </div>
          <div class="flex-1">
