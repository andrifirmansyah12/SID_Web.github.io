        ...
        <div class="row">
            ...
            <div class="row">
                <div class="input-field col s6">
                    ...
                    <input type="number" placeholder="" id="nomor_surat" name="nomor_surat" placeholder=""/>
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input type="date" class="datepicker" placeholder="" id="tanggal_surat" name="tanggal_surat"/>
                <label for="tanggal_surat">Tanggal Surat</label>
                Contoh : 22 Februari 2021
                </div>
                <div class="input-field col s6">
                    <input type="number" placeholder="" id="nik" name="nik" placeholder="Masukkan NIK" autocomplete="off"/>
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input type="date" placeholder="" id="tanggal_lahir" name="tanggal_lahir"/>
