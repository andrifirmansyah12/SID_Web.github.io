...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal text-white bg-yellow-600" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <p class="font-serif text-center py-2 leading-relaxed text-gray-600">
      <span class="font-serif px-2 py-2 bg-blue-900 rounded-md text-white text-md focus:border-transparent"> {{$data->jabatan}} 
      </span>
    </p> --}}
        ...
        <div class='flex max-w-sm w-70 mx-2 my-5 bg-white shadow-2xl border-8 border-gray-600 rounded-lg overflow-hidden mx-auto'>
          <div class='flex items-center w-full px-2 py-2'>
              <div class='mx-3 w-full'>
                  ...
                  <div class='rounded-full cursor-pointer mb-3'><img class="rounded-full" src="{{ url('img-aparaturdesa/' . $data->foto)}}" width="150px"></div>
    ...
    <section class="bg-white border-b py-8">
      <div class="container mx-auto flex flex-wrap pt-4 pb-7">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
          Kabar Desa
        </h1>
        <div class="w-full mb-4">
              ...
              <div class='w-full'>
                <div class="flex mx-auto items-center justify-center">
                  <div class="">
                    ...
                    <div class="flex flex-col max-w-md bg-white px-8 py-3 rounded-xl items-center">
                      <a class="px-24 py-4 bg-indigo-600 rounded-md text-white text-sm focus:border-transparent" href="/kabardesa/informasi{{ $data->id_kabar_desa }}">Baca Selengkapnya ..</a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    @endforelse
    <div class='flex items-center w-full px-2 py-3 mt-5'>
      <div class='w-full'>
        <div class="flex mx-auto justify-end">
          <div class="flex flex-col max-w-md px-8 py-3 rounded-x">
            <a class="px-24 py-4 bg-yellow-600 rounded-md text-white text-md font-bold rounded-full hover:underline focus:outline-none transform transition hover:scale-105 duration-300 ease-in-out" href="/kabardesa/show">Kabar Desa Lain
