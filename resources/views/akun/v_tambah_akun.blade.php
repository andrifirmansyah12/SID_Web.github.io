    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control input-square @error('name') is-invalid @enderror" id="name" name="name" value="{{old('name')}}">
                <div class="invalid-feedback">
                    @error('name')
                    {{ $message }} 
                    @enderror
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control input-square @error('pin') is-invalid @enderror" id="pin" name="pin" value="{{old('pin')}}">
                <div class="invalid-feedback">
                    @error('pin')
                    {{ $message }} 
                    @enderror
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control input-square @error('no_hp') is-invalid @enderror" id="no_hp" name="no_hp" value="{{old('no_hp')}}">
                <div class="invalid-feedback">
                    @error('no_hp')
                    {{ $message }} 
                    @enderror
